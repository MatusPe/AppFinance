...
function StatLoan({text, color, Number}) {
    return (
        <div className="relative   flex flex-col mt-2 rounded-[9px] bg-gradient-to-r text-center flex-grow from-[#3A3535] to-[#1F1B1B]  border border-green-500  text-white font-bold ">
