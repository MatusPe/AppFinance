        ...
        <div className="w-[100%] h-[10vh] border-2 border-green-500 bg-gradient-to-r from-[#3A3535] to-[#1F1B1B] p-2 flex flex-row justify-center max-h-[70px] min-h-[50px]">
            ...
            <NavigationMenu className="mr-2 ml-30">
                <NavigationMenuList>
                    ...
                    <NavigationMenuItem >
                        <NavigationMenuTrigger
                            className="  bg-green-600   text-white font-semibold py-2 px-4 rounded-lg shadow-lg transition-all duration-300  hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-500 mb-1">Login</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <NavigationMenuLink>Link</NavigationMenuLink>
                        </NavigationMenuContent>
